...
?>
	...
	<div id="summaryDiv">
		<button type="button" id="cardPaymentButton" class="btn btn-primary btn-sm" onclick="showCard()">Pay with Card</button>
		<button type="button" id="cashPaymentButton" class="btn btn-primary btn-sm" onclick="showCash()">Pay with Cash</button>
	</div>
...
<a href="index.php" class="btn btn-ams" style="margin-top: 15px;">Cancel payment and return to index.</a>
<?php print_page_end() ?>
</html>
